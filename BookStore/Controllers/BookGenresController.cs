...
namespace BookStore.Controllers
{
    public class BookGenresController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["GenreId"] = new SelectList(_context.Set<Genres>(), "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,GenreId")] BookGenre bookGenre)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Set<Books>(), "Id", "Id", bookGenre.BookId);
            ViewData["GenreId"] = new SelectList(_context.Set<Genres>(), "Id", "Id", bookGenre.GenreId);
            return View(bookGenre);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookStoreContext.BookGenre'  is null.");
            }
            var bookGenre = await _context.BookGenre.FindAsync(id);
            if (bookGenre != null)
            {
